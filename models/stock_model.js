...
GetAllStockById:function(fk_itemId,fk_branchId,callback){
        ...
        return db.query("Select * from Stock as s join item as i on(s.fkItemID=i.itemId) join branch b on(s.fkBranchId=b.branchId) and fkItemId=? and fkBranchId=? ",[fk_itemId,fk_branchId],callback);
},
